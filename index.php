...
if (filter_input(INPUT_POST, "txtEmailRegistro", FILTER_SANITIZE_SPECIAL_CHARS)) {

    $usuario = new Usuario(); //Instância de usuário

    $usuario->setNome(filter_input(INPUT_POST, "txtNomeRegistro", FILTER_SANITIZE_SPECIAL_CHARS));
    $usuario->setEmail(filter_input(INPUT_POST, "txtEmailRegistro", FILTER_SANITIZE_SPECIAL_CHARS));
    $usuario->setSenha(md5(filter_input(INPUT_POST, "txtSenhaRegistro", FILTER_SANITIZE_SPECIAL_CHARS)));
...
if (filter_input(INPUT_POST, "txtEmailLogin", FILTER_SANITIZE_SPECIAL_CHARS)) {
    $usuario = $usuarioController->Autenticar(filter_input(INPUT_POST, "txtEmailLogin", FILTER_SANITIZE_SPECIAL_CHARS), filter_input(INPUT_POST, "txtSenhaLogin", FILTER_SANITIZE_SPECIAL_CHARS));
    if ($usuario != null) {
